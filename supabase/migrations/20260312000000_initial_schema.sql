-- Pixel POS – initial schema for Supabase
...
-- Storage bucket for product images (create in Dashboard → Storage if needed)
...
-- Profiles: users can read all (for admin list), update own
...
-- Shop config: authenticated users can read and update
